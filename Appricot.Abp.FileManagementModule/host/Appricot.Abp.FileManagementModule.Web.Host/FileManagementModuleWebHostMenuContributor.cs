...
public class FileManagementModuleWebHostMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public FileManagementModuleWebHostMenuContributor(IConfiguration configuration)
    {
    ...
    {
        var l = context.GetLocalizer<FileManagementModuleResource>();
