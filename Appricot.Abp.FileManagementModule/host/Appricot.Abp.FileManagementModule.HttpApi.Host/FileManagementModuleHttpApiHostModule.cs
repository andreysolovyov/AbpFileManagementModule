...
using Appricot.Abp.FileManagementModule.EntityFrameworkCore;
...
[DependsOn(
    ...
    typeof(FileManagementModuleEntityFrameworkCoreModule),
...
[DependsOn(typeof(AbpBlobStoringFileSystemModule))]
    public class FileManagementModuleHttpApiHostModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<FileManagementModuleDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, string.Format("..{0}..{0}src{0}Appricot.Abp.FileManagementModule.Domain", Path.DirectorySeparatorChar)));
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<FileManagementModuleApplicationModule>(Path.Combine(hostingEnvironment.ContentRootPath, string.Format("..{0}..{0}src{0}Appricot.Abp.FileManagementModule.Application", Path.DirectorySeparatorChar)));
            });
        }
        ...
        context.Services.AddAbpSwaggerGenWithOAuth(
            ...
            {
                {"FileManagementModule", "FileManagementModule API"}
            },
            options =>
            {
        ...
        context.Services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
            .AddJwtBearer(options =>
            {
                ...
                options.Audience = "FileManagementModule";
            });
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        app.UseAbpSwaggerUI(options =>
        {
            ...
            options.OAuthScopes("FileManagementModule");
        });
        app.UseAuditing();
